...
async function main() {
    ...
    const patients = [
        ...
        { id: 'priya-sharma-p', name: 'Priya Sharma', initials: 'PS', age: 58, gender: 'F', risk: 'high', diagnosis: 'Cardiac Surgery Recovery', recoveryDay: 15, lastLog: dateStr(1), flagged: true, assignedDoctorId: doctorUid, nextAppt: '2026-02-23', vitals: { temp: 37.4, hr: 85, bp: '130/85', spo2: 97 }, lastSymptoms: [{ name: 'Fatigue', severity: 7 }] },
    ...
    const medVisits = [
        {
            ...
            visitDate: '2026-02-08', hospital: 'Apollo Hospitals', department: 'Orthopaedics',
            diagnosis: 'Right Total Knee Replacement Surgery', tags: ['Post-op', 'Orthopaedics'],
            medications: [
                { name: 'Ibuprofen', dosage: '400mg', frequency: '3x/day', duration: '14 days', status: 'active' },
                { name: 'Pantoprazole', dosage: '40mg', frequency: '1x/day', duration: '14 days', status: 'active' },
                { name: 'Enoxaparin', dosage: '40mg/0.4mL', frequency: 'Once daily', duration: '10 days', status: 'completed' },
            ],
            doctorNotes: 'Patient tolerated total knee replacement under spinal anaesthesia. Post-op vitals stable. Non-weight-bearing for 2 weeks, then partial weight-bearing with walker.',
        },
        {
            patientId: patientUid, doctorId: doctorUid, doctorName: 'Dr. Priya Sharma',
            visitDate: '2026-01-15', hospital: 'Apollo Hospitals', department: 'Orthopaedics',
            diagnosis: 'Pre-operative Assessment — Right Knee Osteoarthritis', tags: ['Pre-op', 'Orthopaedics'],
            medications: [
                { name: 'Diclofenac', dosage: '75mg', frequency: '2x/day', duration: '2 weeks', status: 'completed' },
                { name: 'Calcium + Vit D3', dosage: '500mg/250IU', frequency: '2x/day', duration: 'Ongoing', status: 'active' },
            ],
        ...
        {
            patientId: patientUid, doctorId: doctorUid, doctorName: 'Dr. Priya Sharma',
            visitDate: '2025-11-20', hospital: 'General OPD — Subramanya Clinic', department: 'General Medicine',
            diagnosis: 'Hypertension Follow-up', tags: ['Chronic', 'Hypertension'],
            medications: [
                { name: 'Amlodipine', dosage: '5mg', frequency: 'Once daily', duration: 'Ongoing', status: 'active' },
                { name: 'Telmisartan', dosage: '40mg', frequency: 'Once daily', duration: 'Ongoing', status: 'active' },
            ],
    ...
    await db.collection('notifications').doc(doctorUid).collection('items').add({
        ...
        patientId: 'priya-sharma-p', patientName: 'Priya Sharma',
        timestamp: Timestamp.fromDate(daysAgo(1)), read: false,
    });
